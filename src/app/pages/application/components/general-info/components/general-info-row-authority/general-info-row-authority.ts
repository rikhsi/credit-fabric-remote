...
import { LabelControlSecondary, SelectWrapper } from '@shared/components';
...
@Component({
  ...
  imports: [TranslocoDirective, LabelControlSecondary, SelectWrapper, FormField, HandbookDirective, NzOptionComponent],
