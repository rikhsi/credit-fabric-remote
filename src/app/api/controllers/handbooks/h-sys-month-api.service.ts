...
import { SysMonthFilters, SysMonthItem } from '@api/models/handbooks';
...
export class HSysMonthApiService {
  constructor(private http: HttpClient) {}

  public getAll$(filters: SysMonthFilters) {
    return this.http.get<TableOverview<SysMonthItem>>('sys-month', {
