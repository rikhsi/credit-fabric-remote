...
import { OnfTypeFilter, OnfTypeItem } from '@api/models/handbooks';
...
export class HOnfApiService {
  constructor(private http: HttpClient) {}

  public getAll$(filters: OnfTypeFilter) {
    return this.http.get<TableOverview<OnfTypeItem>>('dir-object-new-formation', {
