...
import { KartotekaAllTabComponent, TabValue } from './components/tabs/kartoteka-all-tab';
...
@Component({
  selector: 'app-kartoteka-all',
  imports: [
    BalanceComponent,
    KartotekaAllTabComponent,
    FilterComponent,
    PaginationComponent,
    NgxMaskPipe,
    MatMenuTrigger,
  ...
  templateUrl: './kartoteka-all.component.html',
  styles: `
  `,
})
...
export class KartotekaAllComponent implements OnInit {
  ...
  protected loadList(filter?: FilterRequest) {
    ...
    this.kartoteka2Store.loadKartoteka2List({ paging: { page: this.kartoteka2Store.pageNumber(), size: this.kartoteka2Store.pageSize() }, cardFileType: null, filter: finalFilter })
  }
