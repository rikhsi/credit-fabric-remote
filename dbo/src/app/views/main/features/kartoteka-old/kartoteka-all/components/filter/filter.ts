...
// Interface
import { FilterForm, FilterKeys } from "../../models/kartoteka2.model"
import { STATUSES } from "../../models/kartoteka2.model"
...
export class FilterComponent implements OnInit {
  ...
  private kartoteka2Service = inject(Kartoteka2Service)
  ...
  ngOnInit() {
    this.filterForm.valueChanges
      ...
      .subscribe((formValue) => {
        ...
        const filters: FilterForm = {
          searchText: formValue.searchText?.trim() || null,
    ...
    this.searchbyRecipient.valueChanges.pipe(debounceTime(800)).subscribe((search) => {
      this.kartoteka2Store.loadRecipients(search);

    });

    this.kartoteka2Store.loadRecipients()
