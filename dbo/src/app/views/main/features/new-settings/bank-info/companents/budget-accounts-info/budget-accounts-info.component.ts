...
@Component({
  selector: "app-budget-accounts-info",
  templateUrl: "./budget-accounts-info.component.html",
  styleUrls: ["./budget-accounts-info.component.scss"],
  imports: [
    NgIf,
    FormsModule,
    NgForOf,
...
export class BudgetAccountsInfoComponent implements OnInit {
  data= {}
