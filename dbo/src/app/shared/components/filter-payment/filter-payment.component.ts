...
import { DatePickerDefaultComponent, InputSize } from '../date-picker-default/date-picker-default.component';
...
export class FilterPaymentComponent implements OnInit, OnChanges {
